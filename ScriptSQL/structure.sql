...
('NOTEBOOK APPLE MACBOOK PRO M1 13 INCHES 8GB 256GB SPACE GREY', 2512389, 'Con el chip M1, la MacBook Pro de 13 pulgadas alcanza un nuevo nivel de potencia y velocidad. El CPU es hasta 2.8 veces más rápido y los gráficos son hasta 5 veces más veloces.', 'macbook.jpg', 'Electronica',  0),
...
('MICROPROCESADOR AMD RYZEN 7 5800X 8/16 4.7GHZ S/G S/COOLER ZEN3', 299990, 'Procesador Ryzen 7 5800X para un rendimiento excepcional en tu computadora.', 'ryzen7_5800x.jpg', 'Hardware', 0),
...
('ASUS TUF Gaming VG27AQML1A', 179224, '27 Inch WQHD Monitor - 260 Hz, 1ms GtG, G-Sync, FreeSync, AdaptiveSync, ELMB, GameFast, DisplayHDR 400.', 'monitor.png', 'Perifericos', 0),
